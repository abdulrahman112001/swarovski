      ...
      <div className='grid grid-cols-2 my-[4.5rem]'>
        <div className='flex items-center col-span-1 mx-[4.8rem]'>
          <div>
            ...
            <p dangerouslySetInnerHTML={{ __html: banners?.data[0]?.description }} className='font-[nimbus,sans-serif] text-[1.4rem]  text-center leading-[1.1667] mt-[4.8rem]'>
        ...
        <div className='relative min-w-full col-span-1 overflow-hidden'>
      ...
      <div className='grid grid-cols-2 my-[4.5rem]'>
        ...
        <div className='flex items-center col-span-1 mx-[4.8rem]'>
          <div>
            ...
            <p dangerouslySetInnerHTML={{ __html: banners?.data[1]?.description }} className='font-[nimbus,sans-serif] text-[1.4rem]  text-center leading-[1.1667] mt-[4.8rem]'>
